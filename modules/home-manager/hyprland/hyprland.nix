    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        monitor = [
          ...
          # Laptop configuraiton. Luckily there are no overlaps between identifies
          "eDP-1,1920x1080@60,2680x1440,1" # Laptop
          "DP-7,1920x1080@60,0x360,1" # Omen
          "DP-5,3440x1440@60,1920x0,1" # Wide AOC
          "DP-6,1920x1080@60,5360x0,1,transform,1" # Regular AOC
        ];
